...
void Oled_SH1106::test()
{
	...
	// begin code
	this->sendCommand( SH1106_DISPLAYOFF );
	this->sendCommand( SH1106_SETDISPLAYCLOCKDIV );
	this->sendCommand( 0x80 ); // TODO this may need to be tweaked
	this->sendCommand( SH1106_SETMULTIPLEX );
	this->sendCommand( 0x3F ); // TODO this may need to be tweaked
	...
	this->sendCommand( 0x00 ); // shouldn't need an offset
	this->sendCommand( SH1106_SETSTARTLINE );
	this->sendCommand( SH1106_CHARGEPUMP );
	// TODO or this??? this->sendCommand( 0x10 );
	this->sendCommand( 0x14 );
	this->sendCommand( SH1106_MEMORYMODE );
	this->sendCommand( 0x00 );
	this->sendCommand( SH1106_SEGREMAP | 0x1 );
	this->sendCommand( SH1106_COMSCANDEC );
	this->sendCommand( SH1106_SETCOMPINS );
	this->sendCommand( 0x12 );
	this->sendCommand( SH1106_SETCONTRAST );
	// TODO or this??? this->sendCommand( 0x9F );
	this->sendCommand( 0xCF );
	this->sendCommand( SH1106_SETPRECHARGE );
	// TODO or this??? this->sendCommand( 0x22 );
	this->sendCommand( 0xF1 );
	this->sendCommand( SH1106_SETVCOMDETECT );
	this->sendCommand( 0x40 );
	this->sendCommand( SH1106_DISPLAYALLON_RESUME );
	this->sendCommand( SH1106_NORMALDISPLAY );

	this->sendCommand( SH1106_DISPLAYON );
	*/

	// draw a single pixel
	this->sendCommand( SH1106_SETLOWCOLUMN | 0x0 );
	this->sendCommand( SH1106_SETHIGHCOLUMN | 0x0 );
	this->sendCommand( SH1106_SETSTARTLINE | 0x0 );
	this->sendData( 0xFF );
	this->sendData( 0xFF );
